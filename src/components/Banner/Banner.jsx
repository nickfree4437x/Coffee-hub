...
const Banner = () => {
  return (
    <>
      <span id="about"></span>
      <div style={bgImage}>
        <div className="min-h-[550px] mt-10 ban flex justify-center items-center py-12 sm:py-0 ">
          <div className="container">
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
              ...
              <div className="flex flex-col justify-center gap-6 sm:pt-0">
                ...
                >
                  Single-origin beans, smooth blends, and meticulous brewing methods. Blue Bottle is famous for its freshly roasted beans and minimalistic yet rich flavors.
                </p>
                ...
                <div className="grid grid-cols-2 gap-6">
                  ...
                  >
                    ...
                    Ah, a tea lover! A good cup of tea can be just as comforting and energizing as coffee.
                     What's your favorite type – classic black, green, or maybe a soothing herbal blend?
                    </p>
                  </div>
                </div>
              </div>
